...
public class AppOrderNegativeTest {
    ...
    @Test
    public void shouldFailInvalidName2() {
    ...
    @Test
    public void shouldFailInvalidName3() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иван Иванов");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("6894534");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("[type=button]")).click();
    ...
    @Test
    public void shouldFailInvalidName4() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иван Иванов");
